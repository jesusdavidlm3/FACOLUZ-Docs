...
CREATE TABLE IF NOT EXISTS `consultations` (
  ...
  `dentalDiagram` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `childrenDentalDiagram` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
...
CREATE TABLE IF NOT EXISTS `patients` (
  ...
  `bifosfonato` varchar(50) DEFAULT NULL,
  `bifosfonatoDecription` text DEFAULT NULL,
  `alergy` varchar(50) DEFAULT NULL,
  `alergyDescription` text DEFAULT NULL,
